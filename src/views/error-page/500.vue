        ...
        <div class="error500-body-con">
            <Card>
                ...
                <div class="error500-btn-con">
                    <Button @click="goHome" size="large" style="width: 200px;" type="text">Back to top</Button>
                    <Button @click="backPage" size="large" style="width: 200px;margin-left: 40px;" type="primary">return to previous page</Button>
                </div>
            </Card>
        </div>
    </div>
